...
//                            if (strpos($fullUrl, 'error=logIn')==true) {
//                                echo '<font color="#f0ffff>" <h2 align="center">Welcome Back!! </h2></font color>';
//                            }
//                            ?>
							<h2>Clothes</h2>
							...
							<a href="#target1" class="site-btn sb-line">DISCOVER</a>
							<a name= 'addCart' href="logIn.php?error=logOut" class="site-btn sb-white">ADD TO CART</a>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="row">
						<div class="col-xl-6 col-lg-7 text-#F38181">
							...
							<p>Click on the button below to see our wide range of products, from clothes, accessories to
								groceries, food and home equipment. Get all your want by clicking a few buttons!! </p>
							<a href="#target1" class="site-btn sb-line">DISCOVER</a>
							<a href="logIn.php?error=logOut" class="site-btn sb-white">ADD TO CART</a>
						</div>
					</div>
		</div>
		</div>
	...
	<section class="product-filter-section">
		<div class="container">
			...
			<ul class="product-filter-menu">
				...
				<li><a href="shop.php">TECH</a></li>
				<li><a href="shop.php">BEAUTY & COSMETICS</a></li>
				<li><a href="shop.php">HEALTH</a></li>
                <li><a href="shop.php">HOME AND DECOR</a></li>
			</ul>
			<div class="row">
...
<!--							<div class="tag-sale">ON SALE</div>-->
			...
			<div class="text-center pt-5">
                <a href="logIn.php" class="site-btn"> LOAD MORE </a>
			</div>
		</div>
	</section>
