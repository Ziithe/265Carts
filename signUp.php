    ...
    <div class="main-agileinfo">
        <div class="agileits-top">
            ...
            if (strpos($fullUrl, 'error=password')==true){
                echo '<font color="#f0ffff>" <p align="center">Passwords do not match!</p></font color>';
            }
            elseif (strpos($fullUrl, 'error=invalidemail&Username')==true){
                echo '<font color="#f0ffff>" <p align="center">Invalid Email Address!</p></font color>';
            }
            elseif (strpos($fullUrl, 'error=exist')==true){
                echo '<font color="#f0ffff>" <p align="center">The Email Address is already in Use. Kindly try logging
 in instead</p></font color>';
            }
            ?>
